...
export const repositories: Repository[] = [
  { id: "openneuro", name: "OpenNeuro", short: "ON", datasets: 1204, tier: "Open", status: "online", lastSync: "2 min ago", color: "from-cyan-400 to-blue-500" },
  { id: "dandi", name: "DANDI Archive", short: "DA", datasets: 862, tier: "Open", status: "online", lastSync: "5 min ago", color: "from-blue-400 to-indigo-500" },
  { id: "nitrc", name: "NITRC", short: "NI", datasets: 431, tier: "Open", status: "syncing", lastSync: "12 min ago", color: "from-teal-400 to-cyan-500" },
  { id: "nemar", name: "NEMAR", short: "NE", datasets: 289, tier: "Open", status: "online", lastSync: "8 min ago", color: "from-sky-400 to-cyan-500" },
  { id: "allen", name: "Allen Brain Atlas", short: "AB", datasets: 156, tier: "Open", status: "online", lastSync: "1 hr ago", color: "from-purple-400 to-blue-500" },
  { id: "hcp", name: "Human Connectome", short: "HC", datasets: 96, tier: "Registered", status: "online", lastSync: "20 min ago", color: "from-indigo-400 to-cyan-500" },
  { id: "adni", name: "ADNI", short: "AD", datasets: 74, tier: "Restricted", status: "online", lastSync: "35 min ago", color: "from-blue-500 to-purple-500" },
  { id: "ebrains", name: "EBRAINS", short: "EB", datasets: 512, tier: "Open", status: "online", lastSync: "6 min ago", color: "from-cyan-400 to-teal-500" },
  { id: "ukbb", name: "UK Biobank", short: "UK", datasets: 218, tier: "Restricted", status: "online", lastSync: "1 hr ago", color: "from-blue-400 to-cyan-400" },
  { id: "neuromorpho", name: "NeuroMorpho", short: "NM", datasets: 1875, tier: "Open", status: "syncing", lastSync: "3 min ago", color: "from-teal-400 to-blue-500" },
];
